...
spotmarker_data = read.table("F:/GitDemo/stVGP_F/data/gene_select/select_gene_9.txt",header = T,check.names = FALSE)
...
write.table(result_gene_morans,"F:/GitDemo/stVGP_F/data/gene_select/gene_morans_9.txt",row.names = F, quote = F, sep="\t",col.names = T)
